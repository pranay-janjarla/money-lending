  ...
  const handleAddLoan = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Update the loan context so that the new loan is reflected in the UI.
        // Map backend properties to your frontend model if needed.
        addLoan({
          id: savedLoan._id, // Ensure your backend returns an id compatible with your Loan type.
          type: 'given', // Set the appropriate type.
